 ...
 */
public class CsvColumnNotFoundException extends ColumnException {
   ...
   */
  public CsvColumnNotFoundException(final String columnName) {
    super(columnName, CsvColumnNotFoundException.formatMessage(columnName));
  }
}
