...
import com.javacreed.api.csv.writer.ColumnNotFoundException;
import com.javacreed.api.csv.writer.DuplicateColumnNameException;
...
public class DefaultHeaders implements Headers {
  ...
  public DefaultHeaders(final String... headers) throws DuplicateColumnNameException {
